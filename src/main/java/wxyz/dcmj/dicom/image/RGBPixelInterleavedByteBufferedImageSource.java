...
public class RGBPixelInterleavedByteBufferedImageSource extends ByteBufferedImageSource {

    ColorSpace colorSpace;

    protected RGBPixelInterleavedByteBufferedImageSource(int width, int height, int numberOfFrames, byte[] data, ColorSpace colorSpace) {
    ...
    public BufferedImage getBufferedImage(int imageIndex) {
        ...
        ComponentSampleModel sm = new ComponentSampleModel(DataBuffer.TYPE_BYTE, this.width, this.height, 3, this.width * 3, new int[] { 0, 1, 2 });
