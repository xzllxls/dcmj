...
public class DicomImageWriterSpi extends ImageWriterSpi {
    ...
    public DicomImageWriterSpi() {
        this(DicomImageReaderSpi.VENDOR_NAME, VERSION, DicomImageReaderSpi.FORMAT_NAMES, DicomImageReaderSpi.FILE_SUFFIXES, DicomImageReaderSpi.MIME_TYPES, DicomImageWriter.class.getName(),
                new Class[] { ImageOutputStream.class }, new String[] { DicomImageReaderSpi.class.getName() }, false, DicomStreamMetadataFormat.FORMAT_NAME, DicomStreamMetadataFormat.class.getName(),
                null, null, false, DicomImageMetadataFormat.FORMAT_NAME, DicomImageMetadataFormat.class.getName(), null, null);
    }
